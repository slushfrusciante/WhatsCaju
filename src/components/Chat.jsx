    ...
    >
      ...
      <div className="flex justify-between border-t border-neutral-700 w-100 h-100 py-3">
        ...
        <div className="flex flex-col justify-between items-end h-100 text-xs">
          {/* Time */}
          <p className="text-blue-500 min-w-[55px]">{time}</p>

          {/* Number of messages */}
          {unreadMsgs && (
            <div className="flex justify-center items-center bg-blue-500 rounded-full w-[20px] h-[20px]">
              <p className="text-blue-900">{unreadMsgs}</p>
            </div>
          )}
        </div>
      </div>
