    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex justify-between bg-[#202d33] h-[60px] p-3">
        ...
        <div className="flex items-center">
          ...
          <div className="flex flex-col">
            {/* Contact */}
            <h1 className="text-white font-medium">Suporte de Codigo</h1>

            {/* Status */}
            <p className="text-[#065f96] text-xs">online</p>
          </div>
        </div>
      ...
      <div className="flex items-center bg-[#202d33] w-100 h-[70px] p-2">
        ...
        <input
          ...
          className="bg-[#2D6FBD] rounded-lg outline-none text-sm text-neutral-200 w-100 h-100 px-3 placeholder:text-sm placeholder:text-[#8796a1]"
